...
<svelte:head>
  <title>Contact | Kai Maurin-Jones</title>
  <meta name="description" content="Get in touch with Kai Maurin-Jones" />
</svelte:head>
...
<div class="min-h-screen {mounted ? 'opacity-100' : 'opacity-0'} transition-opacity duration-700">
  <div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
    ...
    <div class="flex flex-col gap-6 mt-8 w-full max-w-md">
      {#each links as link}
        <a
          href={link.url}
