<script lang="ts">
  ...
  const article = {
    title: "365 Days of New Headlines\u200a\u2014\u200aA Longitudinal Analysis Driven by Data Science",
    date: "October 19, 2024",
    categories: ["ai", "algorithms", "data-science", "artificial-intelligence", "large-language-models"],
    mediumUrl: "https://medium.com/@kmaurinjones/365-days-of-new-headlines-a-longitudinal-analysis-driven-by-data-science-b39c9ac9d8e5?source=rss-f832d23db031------2"
  };
