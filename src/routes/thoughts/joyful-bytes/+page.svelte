<script lang="ts">
  ...
  const article = {
    title: "Joyful Bytes: Spreading Positivity Through Daily AI-Generated Art",
    date: "October 28, 2024",
    categories: ["artifical-intellegence", "machine-learning-ai", "large-language-models", "python", "imageai"],
    mediumUrl: "https://medium.com/@kmaurinjones/joyful-bytes-07e29004ed72?source=rss-f832d23db031------2"
  };
