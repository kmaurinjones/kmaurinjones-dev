<script lang="ts">
  ...
  const article = {
    ...
    categories: ["openai", "large-language-models", "retrieval-augmented-gen", "artificial-intelligence", "ai"],
    mediumUrl: "https://medium.com/@kmaurinjones/accelerating-building-code-research-with-rag-an-in-depth-look-c6c89d811f23?sk=cac5b0e1b0ade102c8b6827de465f3a3"
  };
